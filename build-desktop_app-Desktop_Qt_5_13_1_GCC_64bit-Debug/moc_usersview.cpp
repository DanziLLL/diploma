...
#include <memory>
#include "../desktop_app/usersview.h"
...
QT_MOC_LITERAL(1, 10, 20), // "on_btnCreate_clicked"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 23), // "slotCustomMenuRequested"
QT_MOC_LITERAL(4, 56, 14) // "slotDeleteUser"

    },
    "usersview\0on_btnCreate_clicked\0\0"
    "slotCustomMenuRequested\0slotDeleteUser"
};
...
void usersview::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<usersview *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_btnCreate_clicked(); break;
        case 1: _t->slotCustomMenuRequested((*reinterpret_cast< QPoint(*)>(_a[1]))); break;
        case 2: _t->slotDeleteUser(); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject usersview::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_usersview.data,
    qt_meta_data_usersview,
    qt_static_metacall,
    nullptr,
    nullptr
} };
